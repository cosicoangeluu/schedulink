...
export default function EnhancedTodoList({ isCompact = false, onCollapse }: EnhancedTodoListProps) {
  ...
  const getPriorityColor = (dateStr: string | null, completed: boolean) => {
    ...
    if (!dateStr) return 'bg-white border-gray-200';
  ...
  return (
    <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-red-600 to-red-700 p-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm text-red-100">
            ...
            <span className="font-semibold text-white">{completedTasks} / {totalTasks} completed</span>
          </div>
      ...
      {/* Quick Add Form */}
      <div className="px-6 py-4 bg-gradient-to-r from-blue-50 to-red-50 border-b border-blue-100">
        <form onSubmit={handleQuickAdd} className="flex items-center space-x-2">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 border-2 border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm text-gray-900 bg-white placeholder-gray-400"
            />
          </div>
          <button
            type="submit"
            disabled={loading || !quickAddTitle.trim()}
            className="bg-gradient-to-r from-red-500 to-red-600 text-white px-4 py-2.5 rounded-lg hover:from-red-600 hover:to-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium text-sm shadow-md hover:shadow-lg"
          >
          ...
          <form onSubmit={handleAddTask} className="space-y-3">
            <div>
              <input
                ...
                className="w-full px-4 py-2.5 border-2 border-red-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm text-gray-900 bg-white"
                required
              />
            </div>
            <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <input
                ...
                className="px-4 py-2.5 border-2 border-red-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm text-gray-900 bg-white"
              />
              <input
                type="time"
                value={newTask.time}
            ...
            <div className="flex space-x-3">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-gradient-to-r from-red-500 to-red-600 text-white py-3 px-4 rounded-lg hover:from-red-600 hover:to-red-700 disabled:opacity-50 transition-all duration-200 font-semibold shadow-md"
              >
