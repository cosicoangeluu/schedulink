    ...
    >
      ...
      `}>
        ...
        <div className="flex items-center space-x-4 sm:space-x-6 md:space-x-8 relative z-10">
          {/* Icon */}
          <div className="w-14 h-14 sm:w-16 md:w-20 bg-white/30 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg group-hover:rotate-12 transition-transform duration-300">
            <i className={`${icon} text-2xl sm:text-3xl md:text-4xl text-white group-hover:scale-110 transition-transform duration-300`}></i>
          </div>

          {/* Content */}
          <div className="flex-1 text-left min-w-0">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3 group-hover:text-white transition-colors duration-300">
              {title}
            </h3>
          ...
          <div className="flex items-center">
            <i className={`
              ...
              transform transition-all duration-300 group-hover:translate-x-1 group-hover:scale-105
              ${isHovered ? 'translate-x-0.5 scale-102' : ''}
            `}></i>
          </div>
        </div>
      </div>
